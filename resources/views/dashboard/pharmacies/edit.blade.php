                ...
                <div class="mb-3">
                    ...
                    <select name="commune_id" id="city_id" class="form-control select2" required>
                        ...
                        @foreach ($communes as $city)
                            <option
                                value="{{ $city->idcommune }}"{{ $pharmacies->commune_id == $city->idcommune ? 'selected' : '' }}>
                                {{ $city->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="quartier_id" id="quartier_id" class="form-select js-example-basic-single" required>
                        ...
                        @foreach ($quartiers as $quartier)
                            <option
                                value="{{ $quartier->idquartier }}"{{ $pharmacies->quartier_id == $quartier->idquartier ? 'selected' : '' }}>
                                {{ $quartier->nom }}</option>
                        @endforeach
                    </select>
                </div>
