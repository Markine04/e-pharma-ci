 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
         ...
         <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
             ...
             <span class="app-brand-text demo menu-text fw-bold ms-2"><span
                     style="color:rgb(14, 108, 248)">SIHA</span></span>
         </a>
     ...
     <ul class="menu-inner py-1">
         ...
         <!-- Layouts -->
         <li
             class="menu-item {{ Route::is('medicaments.*') ? 'active open' : '' }} {{ Route::is('ordonnances.*') ? 'active open' : '' }}">
             ...
             <ul class="menu-sub">
                 <li class="menu-item  {{ Route::is('medicaments.index') ? 'active' : '' }}">
                     <a href="{{ route('medicaments.index') }}" class="menu-link">
         ...
         <li
             class="menu-item {{ Route::is('categoriemedicaments.*') ? 'active open' : '' }} {{ Route::is('regions.*') ? 'active open' : '' }} {{ Route::is('communes.*') ? 'active open' : '' }}
             ...
             <ul class="menu-sub">
                 ...
                 <li class="menu-item {{ Route::is('users.index') ? 'active' : '' }}">
                     <a href="{{ route('users.index') }}" class="menu-link">
                         <div class="text-truncate" data-i18n="Without navbar">Utilisateurs</div>
                     </a>
                 </li>
                 ...
                 <li
                     class="menu-item {{ Route::is('pharmacies.index') ? 'active' : '' }} {{ Route::is('pharmacies-gardes.*') ? 'active' : '' }}">
                 ...
                 <li class="menu-item {{ Route::is('afficheApp.index') ? 'active' : '' }}">
                     <a href="{{ route('afficheApp.index') }}" class="menu-link">
                         <div class="text-truncate" data-i18n="Without navbar">Affichage App</div>
                     </a>
                 </li>
             </ul>
         </li>
