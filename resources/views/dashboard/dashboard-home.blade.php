                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center"><img class="img-fluid circle"
                                                ...
                                                <div class="flex-grow-1"><span> <a href="{{ route('medicaments.index') }}">Nike
                                                            Shoes</a></span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center"><img class="img-fluid circle"
                                                ...
                                                <div class="flex-grow-1"><span> <a href="#">Tree Pot</a></span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center"><img class="img-fluid circle"
                                                ...
                                                <div class="flex-grow-1"><span> <a href="#">Ck Watch</a></span>
                        ...
                        <div class="owl-carousel owl-theme" id="owl-carousel-1">
                            <div class="item"><img class="img-fluid" src="{{ ('../assets/images/dashboard-2/1.png') }}"
                                ...
                                <div class="product-content">
                                    ...
                                    <h4> <a href="#">Black Apple Airpod</a><i class="fa fa-check-circle"></i>
                                    </h4>
                            ...
                            <div class="item"><img class="img-fluid" src="{{ ('../assets/images/dashboard-2/2.png') }}"
                                ...
                                <div class="product-content">
                                    <div class="badge badge-primary">New</div>
                                    <h4> <a href="#">Red Hova Sport Shoes</a><i class="fa fa-check-circle"></i>
                                    </h4>
                                    <h5 class="f-16">$120.00</h5>
                                </div>
                            </div>
                            <div class="item"><img class="img-fluid" src="{{ ('../assets/images/dashboard-2/3.png') }}"
                                ...
                                <div class="product-content">
                                    <div class="badge badge-primary">New</div>
                                    <h4> <a href="#">Blue Mens Watch</a><i class="fa fa-check-circle"></i></h4>
                                    <h5 class="f-16">$120.00</h5>
                                </div>
                            </div>
                        </div>
