                ...
                <div class="card card-plain">
                    ...
                    <!-- Session Status -->
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div class="mb-3">
                            <input type="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="form-control form-control-lg" placeholder="Email" aria-label="Email">
                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>
                            ...
                            <input type="password"
                            name="password"
                            required autocomplete="current-password" class="form-control form-control-lg" placeholder="Password" aria-label="Password">
                            <x-input-error :messages="$errors->get('password')" class="mt-2" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1 text-center mt-4">Bienvenue sur Siha 👋</h4>
