...
Route::middleware('auth')->group(function () {
    ...
    Route::get('dashboard/medicament/edit/{id}', [MedicamentsController::class, 'edit'])->name('medicaments.edit');
    Route::post('dashboard/medicament-update', [MedicamentsController::class, 'update'])->name('medicaments.update');
    ...
    Route::get('dashboard/pharmacie/edit/{id}', [PharmaciesController::class, 'edit'])->name('pharmacies.edit');
    Route::post('dashboard/pharmacie-update', [PharmaciesController::class, 'update'])->name('pharmacies.update');
    ...
    Route::get('dashboard/pharmacie-garde/edit/{id}', [PharmaciesController::class, 'edit'])->name('pharmacies-gardes.edit');
    Route::post('dashboard/pharmacie-garde-update', [PharmaciesController::class, 'update'])->name('pharmacies-gardes.update');
    ...
    Route::get('dashboard/commune/edit/{id}', [CommunesController::class, 'edit'])->name('communes.edit');
    Route::post('dashboard/commune-update', [CommunesController::class, 'update'])->name('communes.update');
    ...
    Route::get('dashboard/quartier/edit/{id}', [QuartiersController::class, 'edit'])->name('quartiers.edit');
    Route::post('dashboard/quartier-update', [QuartiersController::class, 'update'])->name('quartiers.update');
    ...
    Route::get('dashboard/region/edit/{id}', [RegionsController::class, 'edit'])->name('regions.edit');
    Route::post('dashboard/region-update', [RegionsController::class, 'update'])->name('regions.update');
    ...
    Route::get('dashboard/categorie-medicament/edit/{id}', [CategorieMedicamentsController::class, 'edit'])->name('categoriemedicaments.edit');
    ...
    Route::get('dashboard/ordonnance/edit/{id}', [OrdonnancesController::class, 'edit'])->name('ordonnances.edit');
    Route::post('dashboard/ordonnance-update', [OrdonnancesController::class, 'update'])->name('ordonnances.update');
    ...
    Route::get('dashboard/assurance/edit/{id}', [AssurancesController::class, 'edit'])->name('assurances.edit');
    ...
    Route::get('dashboard/formegalenique/edit/{id}', [FormeGaleniquesController::class, 'edit'])->name('formegaleniques.edit');
    Route::post('dashboard/formegalenique-update', [FormeGaleniquesController::class, 'update'])->name('formegaleniques.update');
    ...
    Route::get('dashboard/affiche-app/edit/{id}', [AffichageAppsController::class, 'edit'])->name('afficheApp.edit');
    Route::post('dashboard/affiche-app-update', [AffichageAppsController::class, 'update'])->name('afficheApp.update');
    ...
    Route::get('dashboard/commande/edit/{id}', [CommandesController::class, 'edit'])->name('commandes.edit');
    Route::post('dashboard/commande-update', [CommandesController::class, 'update'])->name('commandes.update');
    ...
    Route::get('dashboard/panier/edit/{id}', [PaniersController::class, 'edit'])->name('paniers.edit');
    Route::post('dashboard/panier-update', [PaniersController::class, 'update'])->name('paniers.update');
    ...
    Route::get('dashboard/datephciegarde/edit/{id}', [DatePhcieGardeController::class, 'edit'])->name('datephciegardes.edit');
