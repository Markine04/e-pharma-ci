...
// Route::middleware('auth:sanctum')->get('/paniers/{id}', [CartsController::class, 'get_panier']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/ordonnances', [UploadController::class, 'index']);
    ...
    Route::post('/paniers-delete/{userId}/{produitId}', [CartsController::class, 'delete_from_cart']);
    ...
    Route::get('/commande/statut/{id}/{idcommande}/{numerocommande}', [CartsController::class, 'suivicommande']);
